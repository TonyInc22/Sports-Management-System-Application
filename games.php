    ...
    <body>
        ...
        <div class="myDiv">
            <?php
                ...
                */    
                // Create the table
                $columns = array("Team 1 Name", "Team 2 Name", "Week", "Day", "Time", "City", "State", "Indoors", "Score");
                $columnDBNames = array("HomeTName", "AwayTName", "Week", "Day", "Time", "City", "State", "Indoors", "Score");
                $rownum = 0;
                $rows = [["HomeTName"=>"Yankees", "AwayTName"=>"Phillies", "Week"=>"11", "Day"=>"Friday", "Time"=>"6:00 PM", "City"=>"New York", "State"=>"NY", "Indoors"=>"F", "Score"=>"11-12"]];
        ...
        <a href="games.php"><div class="columnBoxDiv", style="width: 16%; height: 100px; line-height:90px"><b style="color:black">GAMES</b></div></a>
