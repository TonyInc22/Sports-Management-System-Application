    ...
    <body>
        ...
        <div class="myDiv">
            <?php
                ...
                */    
                // Create the table
                $columns = array("Team Name", "Record", "Conference");
                $columnDBNames = array("Tname", "Record", "ConName");
                $rownum = 0;
                $rows = [["Tname"=>"Yankees", "Record"=>"10-9", "ConName"=>"National Atlanic"]];
        ...
        <a href="teams.php"><div class="columnBoxDiv", style="width: 16%; height: 100px; line-height:90px"><b style="color:black">TEAMS</b></div></a>
