    ...
    <body>
        ...
        <div class="myDiv">
            <?php
                ...
                */    
                // Create the table
                $columns = array("Conference Name", "Winning Team");
                $columnDBNames = array("ConName", "TName");
                $rownum = 0;
                $rows = [["ConName"=>"Atlantic National", "TName"=>"Yankees"]];
        ...
        <a href="conferences.php"><div class="columnBoxDiv", style="width: 16%; height: 100px; line-height:90px; border-right: 0px none black"><b style="color:black">CONFERENCES</b></div></a>
        </div>
    </body>
</html>